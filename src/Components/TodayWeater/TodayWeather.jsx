        ...
        <div className="block">
            <div className="bg-[#ffffff58] p-4 mb-5 rounded-2xl border border-[#e1e1e18f]">
                <div className="flex justify-between gap-16 text-[#414141]">
                    ...
                    <p className="text-[14px]">{data? data.forecast.forecastday[0].date + ' ' +'(Today)' : '--/--/----'}</p>
                </div>
                ...
                <div className="flex justify-between gap-13 text-[#414141]">
                    <p className="text-[14px]">Latitude: {data ? data.location.lon : '--'}</p>
                    <p className="text-[14px]">Longitude: {data ? data.location.lat : '--'}</p>
                </div>
            </div>
            <Today />
        </div>
